<template>
    <tr class="components" @dblclick="Edit">
        <td>{{ item.box_data.indicator_name }}</td><td>{{ item.box_data.manufacturer_name }}</td><td>{{ item.box_data.lot }}</td>
...
<script>
    ...
    import ReagentLotEditForm from './ReagentLotEditForm.vue';
    export default{
        components: {
            ReagentLotEditForm
        },
